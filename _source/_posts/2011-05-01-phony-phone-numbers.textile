...
categories:
  ...
  - e164
---
This is a post about "Phony 1.4+":http://florianhanke.com/phony/.
...
To add your "missing" country, fork Phony and look at the "lib/countries.rb file":http://github.com/floere/phony/blob/master/lib/phony/countries.rb. It contains (almost) all the definitions. The more complicated ones – like Germany, Italy, etc. – are in their own files.

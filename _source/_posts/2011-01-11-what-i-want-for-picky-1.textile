...
What I will start working on is extracting the HTTP parsing from (probably) Mongrel. For multiprocessing, I could use "procrastinate":https://rubygems.org/gems/procrastinate. The thing that's yet missing is a buffering parent-child communication, which I might write myself, or use one of Kaspar Schiess' future IPC gems :)

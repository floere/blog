...
You might have heard of "CocoaPods":http://cocoapods.org, an Objective-C library dependency manager. The project was initiated by "Eloy Durán":http://twitter.com/alloy.
...
h2. Other fun things to try!

* Search for anything and then click on a pod author name in the results.
* Just enter "Luke 1.0":http://cocoapods.org/?q=luke%21.0 to get all pods written by a luke with version 1.0*.
* Enter e.g. "stacked":http://cocoapods.org/?q=stacked and press various platform buttons to see what happens to the results.

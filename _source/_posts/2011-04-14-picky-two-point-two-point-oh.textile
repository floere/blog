...
The new style is much cleaner to look at. And Picky will tell you if you forgot the data source as early as possible. Still, sorry about the breaking change!

If you use the old style config, Picky will tell you how you need to update your config on server restart.

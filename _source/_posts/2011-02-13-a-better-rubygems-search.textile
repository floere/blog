...
So, while working at his place, I just happened to write one, and more.
...
While the "current search":http://rubygems.org/ isn't bad, it is missing the possibility of searching for an *author*, *where* a gem is used, or which *version* it has. Or any combination thereof, for that matter. Also, it's not too fast.
...
I downloaded the "Marshal":http://rubygems.org/Marshal.4.8.Z file and restructured it into a readable CSV.
...
Those were problematic. What did I do? Compromise, as always – and get the best possible solution.
...
"Check it out":http://gemsearch.heroku.com/, if you haven't yet and tell me what you think "@hanke":http://www.twitter.com/hanke! Do you have ideas for improvement?

...
categories:
  ...
  - picky
---
"Picky":http://florianhanke.com/picky/ 4.0 release - a quick description of the goals and the changes from version 3.6.16. More to come later.
...
* Picky uses the "procrastinate":https://github.com/kschiess/procrastinate gem to parallelize indexing.

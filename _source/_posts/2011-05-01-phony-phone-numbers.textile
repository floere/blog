...
p Phony.formatted('43198110', :format => :international, :spaces => :-) # => '+43-1-98110'
...
Before saving, you could normalize it quickly if it is dirty, to see if it needs to be saved in the specific_phone attribute. This just off the top of my head.
